...
CREATE TABLE public.henkilo (
                ...
                tutkinto VARCHAR(100) DEFAULT Tieto- ja viestintätekniikanperustutkinto NOT NULL,
                etunimi VARCHAR(20) NOT NULL,
                sukumnimi VARCHAR(30) NOT NULL,
                CONSTRAINT henkilo_pk PRIMARY KEY (opiskelijanumero)
);
COMMENT ON TABLE public.henkilo IS 'Henkilötiedot';
